...
const Privacy = () => {
  const policyType = 'privacy'; // Identifiant unique pour la politique de confidentialité
    ...
    queryFn: async () => {
      try {
        ...
        sectionsMap.set(1, {
          ...
          initialContent: "La présente politique de confidentialité",
          paragraphs: []
        });
  ...
  return (
    <PolicyLayout title="Politique de Confidentialité" contentKey={policyType}>
      <div className={cn(
        "flex flex-col",
