...
const CGU = () => {
  const policyType = 'cgu'; // Identifiant unique pour les CGU
    ...
    queryFn: async () => {
      try {
        ...
        sectionsMap.set(1, {
          ...
          initialContent: "Les présentes conditions générales d'utilisation",
          paragraphs: []
        });
  ...
  return (
    <PolicyLayout title="Conditions Générales d'Utilisation" contentKey={policyType}>
      <div className={cn(
        "flex flex-col",
