...
const Legal = () => {
  const policyType = 'legal'; // Identifiant unique pour les mentions légales
    ...
    queryFn: async () => {
      try {
        ...
        sectionsMap.set(1, {
          ...
          initialContent: "Les présentes mentions légales",
          paragraphs: []
        });
  ...
  return (
    <PolicyLayout title="Mentions Légales" contentKey={policyType}>
      <div className={cn(
        "flex flex-col",
