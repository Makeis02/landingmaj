  ...
  useEffect(() => {
    ...
    const loadProductsAndCategories = async () => {
      try {
        ...
        // Trouver la catégorie parente (eau de mer)
        const parentCategory = categoriesData.find(cat => cat.slug === "eau-de-mer");
        if (!parentCategory) {
          throw new Error("Catégorie parente 'eau-de-mer' non trouvée");
        }
        ...
        const cleanedChildCategories = childCategories.filter(cat => cat.slug !== "eau-de-mer");
        ...
        console.error("Erreur lors du chargement des produits. Veuillez réessayer plus tard.", err);
