...
const UniverselsDecoPage = () => {
  ...
  const rawSlug = useParams<{ slug: string }>()?.slug || "universelsdeco";
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      ...
      <SEO
        title="UniverselsDeco"
        description="Découvrez notre sélection UniverselsDeco"
...
export default UniverselsDecoPage;
