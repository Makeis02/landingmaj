...
const OrnementsThematiquesPage = () => {
  ...
  const handleAddToCart = async (product) => {
    ...
    try {
      ...
      <SEO
        title="OrnementsThematiques"
        description="Découvrez notre sélection OrnementsThematiques"
...
return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-4">Catégorie : Ornements thématiques (épaves, statues)</h1>
      <p>Bienvenue sur la page dédiée à la catégorie "Ornements thématiques (épaves, statues)".</p>
      <p>Prochainement : contenu spécifique, produits, fiches conseils…</p>
    </div>
  );
};

export default OrnementsThematiquesPage; 