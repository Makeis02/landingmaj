...
const EauDeMerEntretienPage = () => {
  ...
  const rawSlug = useParams<{ slug: string }>()?.slug || "eaudemerentretien";
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') { // S'assurer que window est disponible (côté client)
      ...
      <SEO
        title="EauDeMerEntretien"
        description="Découvrez notre sélection EauDeMerEntretien"
...
export default EauDeMerEntretienPage;
