...
const EaudemerPompesPage = () => {
  ...
  const rawSlug = useParams<{ slug: string }>()?.slug || "eaudemerpompes";
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') { // S'assurer que window est disponible (côté client)
      ...
      <SEO
        title="EaudemerPompes"
        description="Découvrez notre sélection EaudemerPompes"
...
export default EaudemerPompesPage;
