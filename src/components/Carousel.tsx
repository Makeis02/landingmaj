...
const DragDropContext = React.lazy(() => import('react-beautiful-dnd').then(mod => ({ default: mod.DragDropContext })));
const Droppable = React.lazy(() => import('react-beautiful-dnd').then(mod => ({ default: mod.Droppable })));
const Draggable = React.lazy(() => import('react-beautiful-dnd').then(mod => ({ default: mod.Draggable })));
